...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/approved-users', [RegistrationController::class, 'approvedList'])
    ...
    Route::get('/purchases/vendors-with-dues/{cid}', [PurchaseController::class, 'getVendorsWithDues']);
    Route::get('/purchases/vendor-dues/{vendor_id}', [PurchaseController::class, 'getVendorDues']);
    ...
    Route::get('/products/{id}/prices-by-type', [ProductController::class, 'getPricesByType']);
