...
<body>
    <div class="invoice-container">
        ...
        <div class="footer-section">
            <table>
                <tr><th>Total Items Value</th><td><span class="currency-symbol">₹</span> {{ number_format($total_item_net_value, 2) }}</td></tr>
                <tr><th>Total GST</th><td><span class="currency-symbol">₹</span> {{ number_format($total_gst_amount, 2) }}</td></tr>
                <tr><th>Gross Total</th><td><span class="currency-symbol">₹</span> {{ number_format($total_amount, 2) }}</td></tr>
                @if($absolute_discount > 0)
                <tr><th>Absolute Discount</th><td><span class="currency-symbol">₹</span> {{ number_format($absolute_discount, 2) }}</td></tr>
                @endif
                <tr><th>Payable Amount</th><td><span class="currency-symbol">₹</span> {{ number_format($payable_amount, 2) }}</td></tr>
                <tr><th>Paid Amount</th><td><span class="currency-symbol">₹</span> {{ number_format($paid_amount, 2) }}</td></tr>
                <tr class="total-row"><th>Due Amount</th><td><span class="currency-symbol">₹</span> {{ number_format($due_amount, 2) }}</td></tr>
            </table>
        </div>
