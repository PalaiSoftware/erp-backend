...
<head>
    ...
    <style>
        /* DejaVu Sans = Guaranteed ₹ symbol in DomPDF */
        body {
        ...
        .footer-section td {
            font-weight: bold; /* Only values bold, like Sale Invoice */
            text-align: right;
            min-width: 130px;
        }
        /* Due Amount slightly highlighted but not over-bold */
        .total-row th {
            font-weight: bold;
        }
        .total-row td {
            ...
            <tbody>
                @forelse($items as $index => $item)
                    <tr>
                        ...
                        <td>
                            {{ $item->product_name }}<br> <!-- Removed <strong> -->
