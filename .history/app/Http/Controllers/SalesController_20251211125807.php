...
public function getCustomerDues(Request $request, $customer_id)
{
   ...
   if ($amount > 0) {
    ...
    // Show ledger
   // REPLACE FROM HERE (delete your current ledger query)
...
$bills = DB::table('sales_bills as sb')
    ...
    ->orderBy('sb.updated_at', 'asc') // OLDEST FIRST — CRITICAL FOR FIFO
    ->get();

// Get total money ever paid by customer
...
foreach ($bills as $bill) {
    ...
    // Apply payment from oldest bill first
...
// TO HERE — replace everything in between
